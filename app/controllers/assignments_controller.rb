class AssignmentsController < ApplicationController
  ...
  def create
    ...
    assignment = node.assignments.new(node_name: params[:node_name], title: params[:title], count: params[:count], subject: params[:subject], date: params[:date], user_id: current_user.id)
